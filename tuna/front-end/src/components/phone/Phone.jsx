  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative h-96 w-56 rounded-[24px] border-2 border-b-4 border-r-4 border-white border-l-neutral-200 border-t-neutral-200 bg-white p-1 pl-[3px] pt-[3px]"
      >
        <HeaderBar />
        <Screen />
      </motion.div>
    ...
    return (
      <div className="relative z-0 grid h-full w-full place-content-center overflow-hidden rounded-[20px] bg-white">
        ...
        <img
          src={assets.tunamain}
          alt="Screen Image"
          className="h-full w-full object-cover rounded-[0px]"
        />
